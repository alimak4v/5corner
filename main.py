...
def summarize_news(news_items):
    ...
    prompt = (
        ...
        "**Требования:**\n"
        "• Только факты без пропаганды и оценочных суждений\n"
        ...
        "• Избегай аналитических комментариев\n\n"
        "**Пример формата:**\n"
        "**🚀 Космос**\n"
    ...
    try:
        completion = client_ai.chat.completions.create(
            ...
            messages=[
                {"role": "system",
                 "content": "Вы — опытный аналитик новостей, который профессионально отбирает самые важные новости и группирует их по темам. Используйте критическое мышление и придерживайтесь только фактов."},
    ...
    if news_cache:
        ...
        if summary:
            try:
                ...
                print(f"Сводка опубликована в {TARGET_CHANNEL}")
                clear_news_cache()
